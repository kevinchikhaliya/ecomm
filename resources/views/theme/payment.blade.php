            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control" placeholder="Enter Email id" value="{{$user->email}}" readonly required>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <strong>Event Fees</strong>
                        <input type="text" name="amount" class="form-control" placeholder="" value="{{$amount}}" readonly="">
                    </div>
                </div>
                <div class="col-md-12">
